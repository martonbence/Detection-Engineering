...
Jelenlegi: **6,5 / 10** (kiindulás). Mai állás: **8,88 → 8,9 / 10**, kész súly **88,0 / 92,5**
(51 tétel az 54-ből) — 2026-08-15-én a **4.4** elutasítással zárult (nincs Splunk ES a labor-ban,
a throttling/drilldown fele sem indokolt a jelenlegi méretben — lásd a Napló végét). Korábban:
