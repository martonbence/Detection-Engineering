...
öröklődnek —, és e nélkül a „kézenfekvő" fix csendben tágította volna az írásjogot. **Nyitott
folytatás:** a prod appban egy árnyék maradt, és a javításnak előbb kell prodba érnie, mint a
következő telepítésnek, különben a régi kód mind a 26 korábban kitakarított árnyékot visszagyártja.
...
- **2026-08-08** — **3.9 kész. A tegnapi tanulságot alkalmaztuk: előbb mérés, aztán kód.** A négy
  ...
  **Ami nyitva maradt, és amiért a sorrend számít:** a prod appban egyetlen árnyék van, a tegnapi
  kontrollcsoport (`DETECT-2026-0028`). A többi 26 nem azért nincs meg, mert a javítás hatott, hanem
  mert kézzel törölve lettek és **azóta nem futott prod deploy**. A régi kóddal induló következő
  prod futás mind a 26-ot visszagyártaná, tehát a javításnak előbb kell prodba érnie, mint a
  következő telepítésnek. A takarítás sorrendje ezért: (1) fix prodba, (2) listázás — ha még mindig
  csak a `0028` szerepel, az a fő bizonyíték, (3) a `0028` privát sorának törlése, (4) újabb prod
  futás után újra listázás. Ha előbb törlünk, a 3. lépés bizonyító ereje vész el.
