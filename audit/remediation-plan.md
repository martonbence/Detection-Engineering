...
Jelenlegi: **6,5 / 10** (kiindulás). Mai állás: **8,3 / 10**, kész súly **68 / 92,5**
(39 tétel az 54-ből). A számláló korábban tévesen 69,5-ként szerepelt itt — a 4-es szakaszban
kettő kész (4.3, 4.10), nem három; a `register.html` DOM-jából számolva is 68. A 3.9 felvétele
előtt 68/90,5 = **8,4** volt, most 68/92,5 = **8,3**: a pontszám azért esett, mert új tétel
került a nevezőbe, nem mert bármi visszalépett. (A nevező nőtt: a 2.19, 2.20 és 2.21 új, munka közben talált tétel — a súlyuk a kész oldalon *és* a teljes oldalon is beleszámít. A **2.22** szintén így került be, a 4.3 munkája közben, és a **3.9** ugyanígy, 2026-08-07-én; mindkettő egyelőre csak a teljes oldalon számít.)
...
**A következő tétel a 3.9** — 2026-08-07 este vettük fel, és nem szabadon választható, hanem az,
amivel a következő munkamenet kezdődik. A mechanizmusa bizonyított (a deploy privát névtérbe ír,
ezért minden frissítés árnyék-objektumot hagy), a fixe viszont **hipotézis, amit tesztelni kell**:
`owner=nobody`, `set_acl` nélkül. Azért kell frissen kezdeni vele, mert négy scriptet érint és éles
detekciókat mozgat — nem az a fajta változtatás, amit egy hosszú nap végén szabad elkezdeni.
Fontos, hogy a takarítást **ne** csináljuk meg előtte még egyszer: bizonyítottan visszaépül.

Utána a kör újra szabadon választható, és érdemes megnézni, mi maradt valóban nyitott: a
