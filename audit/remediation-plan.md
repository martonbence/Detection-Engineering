...
Jelenlegi: **6,5 / 10** (kiindulás). Mai állás: **8,1 / 10**, kész súly 58,5/89,5 (33 tétel az 52-ből). (A nevező nőtt: a 2.19, 2.20 és 2.21 új, munka közben talált tétel — a súlyuk a kész oldalon *és* a teljes oldalon is beleszámít.)
...
## 2 · Kisebb hibák és optimalizálás (21)
