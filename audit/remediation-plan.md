...
Jelenlegi: **6,5 / 10** (kiindulás). Mai állás: **8,96 → 9,0 / 10**, kész súly **91,0 / 92,5**
(53 tétel az 54-ből) — 2026-08-15-én a **4.8** is elutasítással zárult (a meglévő rule browser
drawer már lefedi a tétel nagy részét, a maradék nem indokolt jelenleg — lásd a Napló végét).
Korábban: (52 tétel az 54-ből) — a **4.1** is elutasítással zárult (nincs háttérforgalom a
