...
Jelenlegi: **6,5 / 10** (kiindulás). Mai állás: **7,8 / 10**, kész súly 49,5/89,5. (A nevező nőtt: a 2.19, 2.20 és 2.21 új, munka közben talált tétel — a súlyuk a kész oldalon *és* a teljes oldalon is beleszámít.)
