...
<p align="center">
  <a href="https://raw.githubusercontent.com/martonbence/Detection-Engineering/main/docs/architecture/Workflow.drawio.svg">
...
<p align="center"><sub>Click the diagram to open the full-size vector in a new tab (browser zoom works cleanly on the raw SVG).</sub></p>
