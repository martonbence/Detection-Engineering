...
| [[T1040 - Network Sniffing]]                               | közepes      | részleges   | DETECT-2026-0044 (`experimental`): `netsh trace`, `pktmon`, Wireshark/`tshark`/`dumpcap`/RawCap, NetEventPacketCapture |
...
Jelenleg **15 szabály**: 13 (DETECT-2026-0019 … 0031) [[T1003 - OS Credential Dumping]] alatt, **DETECT-2026-0033** ([[T1557 - Adversary-in-the-Middle]] .001 — AiTM tool-futás, `critical`), és **DETECT-2026-0044** ([[T1040 - Network Sniffing]], packet-capture tool- és beépített Windows-eszköz futás, `medium`). Ez utóbbi 2026-09-26-án készült el elsőként a technikára — a korábban itt szereplő DETECT-2026-0035 hivatkozás elavult volt (az a szabály 2026-09-10-én törlésre került, mielőtt bármi is épült volna rá), ezért ez a bejegyzés a táblázatban addig tévesen "részleges" lefedettséget mutatott egy nem létező szabályra hivatkozva. DETECT-2026-0033 története: DETECT-2026-0034 néven készült, és eredetileg a T1557.001 poisoning-tooling és a T1040 packet-capture detekciót is egy szabályban fedte; 2026-09-10-én T1557.001-only szabállyá szűkült (a T1040 ág a fent említett, azóta törölt DETECT-2026-0035-be vált ki), majd — ugyanaznap — DETECT-2026-0033-ra lett átszámozva, mert a szám időközben felszabadult: a **korábbi, ezt a számot viselő szabály** (egy teljesen más logikájú DNS-hiba → SMB korreláció kísérlet) 2026-09-10-én törölve lett, nem igazolt előfeltevés miatt — a mostani DETECT-2026-0033 vele tartalmilag semmilyen kapcsolatban nincs, csak a számot örökölte. Ez azt jelenti, hogy a Sysmon-alapú végponti oldal két technikán (T1557.001, T1040) már megkezdett, a natív DC-log oldal ([[T1558 - Steal or Forge Kerberos Tickets]], DCSync, spraying) viszont teljesen üres.
