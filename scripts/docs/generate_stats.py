...
<head>
  ...
  <style>
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .att-matrix {{ display:flex; gap:2px; overflow-x:auto; padding-bottom:8px; scrollbar-width:thin; scrollbar-color:#FFAA00 #21262d; }}
    .att-matrix::-webkit-scrollbar {{ height:6px; }}
    .att-matrix::-webkit-scrollbar-track {{ background:#21262d; border-radius:3px; }}
    .att-matrix::-webkit-scrollbar-thumb {{ background:#FFAA00; border-radius:3px; }}
